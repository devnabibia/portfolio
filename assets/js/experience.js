...
const exp = [
  ...
  },
  {
    ...
    place: "County Government of Uasin Gishu, Kenya",
    time: "(May, 19 - Aug, 19)",
    desp: "<li>Monitored the IT services technical support and in store technologies aligned  with HMIS</li><li>Monitored the IT services desk and evaluated incoming queues, and the allocation of queries to the correct team or engineer for prompt resolution.</li>",
  },
];

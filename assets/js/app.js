...
<a class="navbar-brand" href="index.html">Dennis Nangend0 </a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <h5 class="tag" >"Cause everybody wants something from me now and I don't wanna let 'em down"~ Billie Eilish.</h5>
    </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                <h5>Message me here</h5><br/>
               <h6> <i class="fa fa-envelope" aria-hidden="true"> nangendodennis@gmail.com</i></h6>
    ...
    <h6>Front-end engineer and Technical Writer.</h6>

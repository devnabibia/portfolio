    ...
    >
      <figcaption className="lg:w-6/12 w-full md:w-11/12">
        ...
        <p className="py-6 text-sm text-justify leading-7">
          ...
          frontend and backend  work experience by contributing to a couple of projects. 
        ...
        <figure className="flex justify-between items-center w-40 py-1">
          <Link to="https://github.com/devnabibia" target="_blank">
            <img src={GitHub} alt="GitHub" className="h-10 w-10" />
          </Link>
          <Link to="https://hashnode.com/@devnabibia"target="_blank" >
            <SiHashnode className="h-6 w-6" />
          </Link>
          <Link to="https://www.linkedin.com/in/devnabibia/" target="_blank">
            <FiLinkedin className="h-6 w-6" />
          </Link>
          <Link to="https://twitter.com/devnabibia" target="_blank">
